...
** Highlights: This enhancement includes a new variable to the patient class. It required an in-depth analysis of design alternatives as it stores a list of records, which then stored various other new classes. The implementation was challenging as it required a way to
...
* *Code contributed*: [https://github.com/CS2103JAN2018-W15-B2/main/blob/master/collated/functional/nhs-work.md[Functional code]]

* *Other contributions*:

** Community:
*** PRs reviewed (with non-trivial review comments): https://github.com/CS2103JAN2018-W15-B2/main/pull/101[#101], https://github.com/CS2103JAN2018-W15-B2/main/pull/205[#205]
